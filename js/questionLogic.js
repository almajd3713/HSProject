...
let questionChange = (id, question, answer) => {
  ...
  answer.forEach(ans => {ans.style.opacity = 0; ans.style.backgroundColor = "#6f64be";ans.style.color = "#eee"})
  setTimeout(() => {
    ...
    box.addEventListener("click", () => {
      boxes.forEach(box2 => {
        if(box2.textContent === answer) {
          box2.style.backgroundColor = "#3cec4b"
          box2.style.color = "#333"
        }
        else box2.style.backgroundColor = "#e50b0b"
      })
    })
  })
}
